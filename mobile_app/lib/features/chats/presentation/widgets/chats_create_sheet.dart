            ...
            child: AppSurface(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Выберите формат общения и начните разговор сразу в нужном режиме.',
                  ...
                  _CreateChatOption(
                    ...
                    title: 'Личный чат',
                    subtitle: 'Один собеседник, быстрый старт и приватный диалог',
                  ...
                  _CreateChatOption(
                    icon: AppIcons.group,
                    title: 'Групповой чат',
                    subtitle: 'Команда, друзья или рабочая комната в одном пространстве',
